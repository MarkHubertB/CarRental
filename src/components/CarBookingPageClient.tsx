...
const TYPE_LABEL: Record<string, string> = {
  van: 'Group / Tour', suv: 'Family SUV', mpv: 'MPV', hatchback: 'City / Solo',
}
...
export default function CarBookingPageClient({ carId }: CarBookingPageClientProps) {
  ...
  const getCarImage = () => {
    ...
    if (modelLower.includes('hi-ace') || modelLower.includes('hiace')) return '/cars/toyota_hi-ace.jpg'
    if (modelLower.includes('rush')) return '/cars/toyota rush.jpg'
    if (modelLower.includes('avanza')) return '/cars/toyota-avanza.jpg'
    if (modelLower.includes('celerio')) return '/cars/Maruti_Suzuki_Celerio.avif'
  ...
  if (loading) {
    return (
      <main><Navbar />
        <div style={{ padding: '2rem', textAlign: 'center', color: 'var(--text3)' }}>Loading car details...</div>
      </main>
    )
  }
          ...
          <section style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            <div style={{
              ...
              <div style={{
                ...
                letterSpacing: '0.1em', color: '#D4A843',
                textTransform: 'uppercase',
              }}>
                {car.type}
              </div>
            ...
            <article style={{
              ...
              <div style={{
                ...
                {[
                  ...
                  <div key={label}>
                    <p style={{ color: 'var(--text3)', fontSize: '.72rem', marginBottom: '.3rem', letterSpacing: '0.09em', textTransform: 'uppercase' }}>
                      {label}
                    </p>
                    {isColor ? (
                      <div style={{ display: 'flex', alignItems: 'center', gap: '.5rem' }}>
                        ...
                        <span style={{ fontSize: '.9rem', textTransform: 'capitalize' }}>{value}</span>
                      </div>
                    ) : (
              ...
              <div style={{
                ...
                <span style={{ fontSize: '.8rem', color: 'var(--text3)', letterSpacing: '0.05em', textTransform: 'uppercase' }}>Rate per day</span>
            ...
            <div style={{
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem', flex: 1 }}>
                ...
                <div style={{
                  ...
                  <h3 style={{ fontSize: '.85rem', color: 'var(--text3)', marginBottom: '.8rem', letterSpacing: '0.05em', textTransform: 'uppercase' }}>
                    Price Summary
                  </h3>
                  <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '.85rem', color: 'var(--text3)', marginBottom: '.4rem' }}>
                    <span>Daily Rate</span>
                    <span style={{ color: 'var(--text)' }}>â‚±{car.price_per_day.toLocaleString()}</span>
                  </div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '.85rem', color: 'var(--text3)', marginBottom: '.4rem' }}>
                    <span>Duration</span>
                  ...
                  <div style={{
                    ...
                    paddingTop: '.8rem', borderTop: '1px solid rgba(212,168,67,0.2)',
